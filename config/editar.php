...
<body>
    <div class="container">
        ...
        <button  type="button" class="btn btn-danger p-2" onclick="confirmarExclusao()"><i class="fa-solid fa-trash p-2 "></i>     Excluir </i></button>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="ficha" role="tabpanel" aria-labelledby="ficha-tab">
                <form action="editar.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" class="form-control" id="nascimento" name="nascimento" value="<?php echo $nascimento; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <button type="button" onclick="window.location.href='../front/home.php'" class="btn btn-secondary btn-block">Cancelar</button>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <?php if ($resulthistoricos->num_rows > 0): ?>
                            <ul class="list-group">
                                <?php while($row = $resulthistoricos->fetch_assoc()): ?>
                                    <li class="list-group-item historico-item" onclick="location.href='editar_historico.php?id=<?php echo $row['id']; ?>'">
